...
// TestGetMembersEndpoint_Ok test `GET /members` endpoint.
func TestGetMembersEndpoint_Ok(t *testing.T) {
...
// TestGetMembersEndpoint_Error test `GET /members` endpoint for all negative cases.
func TestGetMembersEndpoint_Error(t *testing.T) {
