...
//
// NewHTTP429Error returns HTTP 429 (TooManyRequests) error.
//
func NewHTTP429Error(code int, msg string) HTTPError {

	return NewHTTPError(http.StatusTooManyRequests, code, msg)
}
